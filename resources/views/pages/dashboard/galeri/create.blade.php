<x-app-layout>
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-gray-800 leading-tight">
            Product &raquo; {{ $produk->nama_produk }} &raquo; Galeri &raquo; Upload Foto
        </h2>
    </x-slot>
    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div>
                ...
                @endif
                <form class="w-full" action="{{ route('dashboard.produk.galeri.store',  $produk->id) }}" method="post" enctype="multipart/form-data">
                    @csrf
